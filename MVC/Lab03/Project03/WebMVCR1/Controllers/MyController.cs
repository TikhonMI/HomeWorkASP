...
namespace WebMVCR1.Controllers
{
                                           ...
                                           // -- Lab3.2(3)Настройка контроллера.3 Переименовали MyController в HomeController, в Program переименовали My в Home 
    {
        ...
        */
        ...
        private static PersonRepository db = new PersonRepository();//Lab3.3(2)Настройка контроллера.1 Добавили код создания статического объекта репозитория:
        ...
        {
            db.AddResponse(p); //Lab3.3(2)Настройка контроллера.2 код добавления объекта Person в коллекцию db
        ...
        //Lab3.3(2)Настройка контроллера.3 новый метод действия, реализующий получение коллекции и информации о ее размере в динамический объект ViewBag:
        public ViewResult OutputData()
        {
            ...
            //Lab3.3(3)Добавление строго типизированного представления для отображения коллекции.1 Добавляем пустое представления:
            //a. щелкните п.к.м. внутри методоа OutputData(), Добавить представление
            //b. Выберите именно пустое представление
            //c. Имя представления – ListPerson
        }
    }
}
